...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "A quiet luxury house for fragrances and Arabian oils — sourced globally, kept selectively, delivered with care." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Souk Privé — Where Quality Lives" },
      { name: "twitter:description", content: "A quiet luxury house for fragrances and Arabian oils — sourced globally, kept selectively, delivered with care." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/647c41c7-8549-40ed-b109-1a890ec931b9/id-preview-0029485d--eeba3c1e-cd63-4ab7-b6fd-25618c0427a5.lovable.app-1778231113233.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/647c41c7-8549-40ed-b109-1a890ec931b9/id-preview-0029485d--eeba3c1e-cd63-4ab7-b6fd-25618c0427a5.lovable.app-1778231113233.png" },
    ],
    links: [
